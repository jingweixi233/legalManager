...
file = open("criminal.json",'r', encoding = 'utf-8')
...
for key, value in dict_crime_first_instances.items():
    try:
        ...
        #print(dict_crime_first_instance_appeal[key])
    except:
...
for key, value in dict_crime_first_instances.items():
    try:
        ...
        #{...'id':'诉请句'}；用的是审理经过的value作为string
            ...
            #print(dict_crime_first_instance_reply[key])
        except:
...
csv_reader = csv.reader(open("name.csv",'r', encoding='UTF-8-sig'))
accusations = []
